...
export const ErrorCode = {
  ...
  /** ลบจุดรับที่ยังมีใบงานอ้างอยู่ไม่ได้ — Q-051 · T-099 */
  ...
  /** รหัสประจำตัวที่กรอกในหน้าเชื่อมต่อ LINE ไม่ตรงกับ profile ที่ลิงก์ระบุ — REQ-SEC-032 (ลิงก์ยังไม่ถูกใช้ทิ้ง) */
  LINE_LINK_STAFF_CODE_MISMATCH: 'LINE_LINK_STAFF_CODE_MISMATCH',
